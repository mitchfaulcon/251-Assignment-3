    ...
    public void processForm(Form form) {
        ...
        SwingWorker worker = new SwingWorker() {
            ...
            protected Object doInBackground() throws Exception {
                ...
                int width = _form.getFieldValue(Integer.class, RobotFormElement.WIDTH);
                int deltaX = _form.getFieldValue(Integer.class, RobotFormElement.DELTA_X);
                int deltaY = _form.getFieldValue(Integer.class, RobotFormElement.DELTA_Y);
